...
class FirebaseUser {
  ...
  FirebaseUser({this.displayName, this.email, this.photoURL, this.morningRoutines, this.nightRoutines, this.journalEntries, this.dailyCheckins, this.endOfTheDayJournal, this.projectsIDList, this.xpAmount, this.level});

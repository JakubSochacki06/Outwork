      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context)!.createNightRoutine,
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    labelText: AppLocalizations.of(context)!.nightRoutine,
                    labelStyle: Theme.of(context).primaryTextTheme.bodyMedium,
                    hintText: AppLocalizations.of(context)!.addNightRoutineHint),
              ),
            ),
            SizedBox(
              height: height * 0.01,
                ...
                if(userProvider.user!.isPremiumUser! || nightRoutineProvider.nightRoutines.length < 3){
                  if(checkIfValid()){
                    if(nightRoutineProvider.scheduledTime!=null){
                      ...
                      await createRoutineReminderNotification(nightRoutineProvider.scheduledTime!, _nightRoutineController.text, userProvider.user!.toughModeSelected!, context);
                    }

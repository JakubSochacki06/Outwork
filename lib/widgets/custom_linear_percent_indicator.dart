...
class CustomLinearPercentIndicator extends StatefulWidget {
  ...
  final Radius? barRadiusTopRight;
  final Radius? barRadiusBottomRight;
  ...
  CustomLinearPercentIndicator({
    ...
    this.barRadiusBottomRight,
    this.barRadiusTopRight,
  ...
  @override
  _CustomLinearPercentIndicatorState createState() => _CustomLinearPercentIndicatorState();
}

class _CustomLinearPercentIndicatorState extends State<CustomLinearPercentIndicator>
        ...
        children: [
          CustomPaint(
            ...
            painter: _LinearPainter(
              ...
              barRadiusBottomRight: widget.barRadiusBottomRight ?? Radius.zero,
              barRadiusTopRight: widget.barRadiusTopRight ?? Radius.zero,
...
class _LinearPainter extends CustomPainter {
  ...
  _LinearPainter({
    ...
    required this.barRadiusBottomRight,
    required this.barRadiusTopRight,
    this.linearGradient,
    this.maskFilter,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    backgroundPath.addRRect(RRect.fromRectAndCorners(
        Rect.fromLTWH(0, 0, size.width, size.height), topRight: barRadiusTopRight, bottomRight: barRadiusBottomRight));
    ...
    if (isRTL) {
      ...
      linePath.addRRect(RRect.fromRectAndCorners(
          Rect.fromLTWH(
              size.width - size.width * progress, 0, xProgress, size.height),
          topRight: barRadiusTopRight, bottomRight: barRadiusBottomRight));
    } else {
      if (linearGradient != null) {
        _paintLine.shader = _createGradientShaderLeftToRight(size, xProgress);
      }
      linePath.addRRect(RRect.fromRectAndCorners(
          Rect.fromLTWH(0, 0, xProgress, size.height), topRight: barRadiusTopRight, bottomRight: barRadiusBottomRight));
    }
